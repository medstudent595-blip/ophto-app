...
export const allCourses = [
  ...
  { id: 'sep-pediatrique', title: 'SEP Pédiatrique & Diagnostics Différentiels', category: 'Neuro-Ophtalmologie', description: 'Diagnostic, bilan étiologique, MOGAD, NMOSD et prise en charge thérapeutique de la SEP pédiatrique.', has: { cours: true, fiches: true, algorithms: false, classifications: false, qcm: false } },
  ...
  { id: 'sarcoidose-oculaire', title: 'Sarcoïdose Oculaire', category: 'Uvéites', description: 'Sémiologie, critères IWOS 2009, bilan et stratégie thérapeutique de l\'uvéite sarcoïdosique.', has: { cours: true, fiches: false, algorithms: false, classifications: false, qcm: false } },
